...
function downloadReturnPDF() {
  ...
  doc.text("Generated by Financee Accounting System", margin, 14);
  doc.setFontSize(11);
  doc.text("PURCHASE RETURN INVOICE", margin, 23);
  doc.setDrawColor(147, 197, 253); doc.setLineWidth(0.6);
  doc.line(margin, 29, W - margin, 29);
  doc.setFontSize(8.5); doc.setFont("helvetica", "normal");
  doc.text(`Return #${returnId}`, W - margin, 14, { align: "right" });
  doc.text(`Date: ${date}`, W - margin, 22, { align: "right" });
  ...
  doc.text("Developed by Maaz Rehan", margin, y);
