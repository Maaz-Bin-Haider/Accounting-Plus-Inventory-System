...
//   if (type === "stock") $("#btn-stock").addClass("active");
//   else if (type === "worth") $("#btn-worth").addClass("active");
//   else $("#btn-history").addClass("active");
...
//     fetchReport("/accountsReports/stock-report/");
//   } else if (type === "worth") {
//     $("#report-form-container").html("");
//     fetchReport("/accountsReports/stock-worth-report/");
//   } else {
//     renderItemHistoryForm();
//   }
// }
...
// // 🧾 Item History Form
// // ==========================
// function renderItemHistoryForm() {
//   const formHTML = `
...
//                autocomplete="off"
//                data-autocomplete-url="/items/autocomplete-item/">
...
//   $("#reportHeader").html("");
//   $("#reportBody").html(`<tr><td class="no-data">Enter an item name to view history</td></tr>`);
//   initAutocomplete();
// }
...
//       else renderTable(data);
//     })
//     .catch(() => Swal.fire("Error", "Unable to fetch report.", "error"));
// }
...
//     if (!$(e.target).closest("#item_name, #suggestions").length) {
//       $suggestions.hide();
//     }
//   });
// }
...
// stock_reports.js
// Handles: stock, worth and item-history with autocomplete, keyboard nav and PDF export
