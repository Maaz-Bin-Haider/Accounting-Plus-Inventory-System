...
\restrict a0YqUpUTL5neiALUD2W1uXbNOPs7AzI6jNZnaRAE7Ue2XkR49vYVWHglrkgAOnD
...
--
-- Name: create_purchase(bigint, date, jsonb, integer); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.create_purchase(p_party_id bigint, p_invoice_date date, p_items jsonb, p_created_by integer) OWNER TO postgres;
...
--
-- Name: create_purchase_return(text, jsonb, integer); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.create_purchase_return(p_party_name text, p_serials jsonb, p_created_by integer) OWNER TO postgres;
...
--
-- Name: create_sale(bigint, date, jsonb, integer); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.create_sale(p_party_id bigint, p_invoice_date date, p_items jsonb, p_created_by integer) OWNER TO postgres;
...
--
-- Name: create_sale_return(text, jsonb, integer); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.create_sale_return(p_party_name text, p_serials jsonb, p_created_by integer) OWNER TO postgres;

--
-- Name: delete_contra(bigint); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.delete_contra(p_id bigint) RETURNS jsonb
    LANGUAGE plpgsql
    AS $$
BEGIN
...
ALTER FUNCTION public.delete_contra(p_id bigint) OWNER TO postgres;
...
--
-- Name: detailed_ledger2(text, date, date); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: fn_dash_expense_kpi(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: fn_dash_fast_moving_items(integer, integer); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: fn_dash_low_stock_items(integer); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: fn_dash_receivables_aging(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: fn_dash_recent_transactions(integer); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: fn_dash_sales_last7days(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: fn_dash_sales_range(date, date); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: fn_dash_sales_today_kpi(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: fn_dash_smart_alerts(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: fn_dash_stale_stock(integer); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: fn_dash_stock_kpi(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: fn_dash_top_customers(integer, date, date); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: fn_dash_top_expense_categories(integer, date, date); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: fn_dash_top_expense_descriptions(integer, date, date); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: fn_dash_top_vendors(integer, date, date); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: get_accounts_payable_json_excluding(text[]); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: get_accounts_receivable_json_excluding(text[]); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: get_cash_ledger_with_party(date, date); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: get_contra_details(bigint); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.get_contra_details(p_id bigint) RETURNS jsonb
    LANGUAGE plpgsql
    AS $$
...
ALTER FUNCTION public.get_contra_details(p_id bigint) OWNER TO postgres;

--
-- Name: get_contras_by_date_json(jsonb); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.get_contras_by_date_json(p_data jsonb) RETURNS jsonb
    LANGUAGE plpgsql
    AS $$
...
ALTER FUNCTION public.get_contras_by_date_json(p_data jsonb) OWNER TO postgres;
...
--
-- Name: get_item_stock_by_name(character varying); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: get_last_20_contras_json(jsonb); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.get_last_20_contras_json(p_data jsonb) RETURNS jsonb
    LANGUAGE plpgsql
    AS $$
DECLARE result JSONB;
BEGIN
...
ALTER FUNCTION public.get_last_20_contras_json(p_data jsonb) OWNER TO postgres;
...
--
-- Name: get_last_contra(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.get_last_contra() RETURNS jsonb
    LANGUAGE plpgsql
    AS $$
DECLARE result JSONB;
BEGIN
...
ALTER FUNCTION public.get_last_contra() OWNER TO postgres;
...
--
-- Name: get_next_contra(bigint); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.get_next_contra(p_id bigint) RETURNS jsonb
    LANGUAGE plpgsql
    AS $$
DECLARE result JSONB;
BEGIN
...
ALTER FUNCTION public.get_next_contra(p_id bigint) OWNER TO postgres;
...
--
-- Name: get_party_balance_by_name(text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.get_party_balance_by_name(p_name text) OWNER TO postgres;
...
--
-- Name: get_party_balances_json_excluding(text[]); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: get_previous_contra(bigint); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.get_previous_contra(p_id bigint) RETURNS jsonb
    LANGUAGE plpgsql
    AS $$
DECLARE result JSONB;
BEGIN
...
ALTER FUNCTION public.get_previous_contra(p_id bigint) OWNER TO postgres;
...
--
-- Name: get_serial_ledger_purchase(text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: get_serial_ledger_sales(text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: make_contra(jsonb); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.make_contra(p_data jsonb) RETURNS jsonb
    LANGUAGE plpgsql
    AS $$
DECLARE
...
ALTER FUNCTION public.make_contra(p_data jsonb) OWNER TO postgres;
...
--
-- Name: monthly_company_position(date); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: monthly_income_statement(date, date, numeric, numeric); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: trg_contra_journal(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.trg_contra_journal() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
DECLARE
    j_id      BIGINT;
...
ALTER FUNCTION public.trg_contra_journal() OWNER TO postgres;

--
-- Name: trg_fn_soldunits_fix_ghost_stock(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION trg_fn_soldunits_fix_ghost_stock(); Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: update_contra(bigint, jsonb); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.update_contra(p_id bigint, p_data jsonb) RETURNS jsonb
    LANGUAGE plpgsql
    AS $$
DECLARE
...
ALTER FUNCTION public.update_contra(p_id bigint, p_data jsonb) OWNER TO postgres;
...
--
-- Name: update_purchase_invoice(bigint, jsonb, text, date, integer); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.update_purchase_invoice(p_invoice_id bigint, p_items jsonb, p_party_name text, p_invoice_date date, p_created_by integer) OWNER TO postgres;
...
--
-- Name: update_purchase_return(bigint, jsonb, integer); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.update_purchase_return(p_return_id bigint, p_serials jsonb, p_created_by integer) OWNER TO postgres;
...
--
-- Name: update_sale_invoice(bigint, jsonb, text, date, integer); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.update_sale_invoice(p_invoice_id bigint, p_items jsonb, p_party_name text, p_invoice_date date, p_created_by integer) OWNER TO postgres;
...
--
-- Name: update_sale_return(bigint, jsonb, integer); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.update_sale_return(p_return_id bigint, p_serials jsonb, p_created_by integer) OWNER TO postgres;
...
--
-- Name: validate_purchase_update2(bigint, jsonb); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: contra_entries; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.contra_entries (
    contra_id bigint NOT NULL,
    from_party_id bigint NOT NULL,
    to_party_id bigint NOT NULL,
    amount numeric(14,4) NOT NULL,
    contra_date date DEFAULT CURRENT_DATE NOT NULL,
    ...
    created_by integer,
    date_created timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT contra_amount_pos CHECK ((amount > (0)::numeric)),
...
--
-- Name: TABLE contra_entries; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON TABLE public.contra_entries IS 'Party-to-party transfers (contra). Debit To-party / Credit From-party; no cash.';


--
-- Name: contra_entries_contra_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public.contra_entries ALTER COLUMN contra_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.contra_entries_contra_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: contra_ref_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.contra_ref_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE public.contra_ref_seq OWNER TO postgres;
...
--
-- Name: COLUMN purchaseunits.serial_comment; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: item_last_purchase_view; Type: VIEW; Schema: public; Owner: postgres
--
...
--
-- Name: item_last_sale_view; Type: VIEW; Schema: public; Owner: postgres
--
...
--
-- Name: vw_dash_daily_sales; Type: VIEW; Schema: public; Owner: postgres
--
...
--
-- Name: vw_dash_expenses; Type: VIEW; Schema: public; Owner: postgres
--
...
--
-- Name: vw_dash_party_ar_balance; Type: VIEW; Schema: public; Owner: postgres
--
...
--
-- Name: vw_dash_stock_overview; Type: VIEW; Schema: public; Owner: postgres
--
...
31	EXP-0015	PROFIT	Expense	\N	2026-02-02 16:09:10.176848
\.


--
-- Data for Name: contra_entries; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
SELECT pg_catalog.setval('public.auth_group_id_seq', 31, true);
...
SELECT pg_catalog.setval('public.auth_user_groups_id_seq', 123, true);
...
SELECT pg_catalog.setval('public.chartofaccounts_account_id_seq', 31, true);


--
-- Name: contra_entries_contra_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.contra_entries_contra_id_seq', 209, true);


--
-- Name: contra_ref_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.contra_ref_seq', 209, true);
...
SELECT pg_catalog.setval('public.items_item_id_seq', 268, true);
...
SELECT pg_catalog.setval('public.journalentries_journal_id_seq', 5418, true);
...
SELECT pg_catalog.setval('public.journallines_line_id_seq', 13200, true);
...
SELECT pg_catalog.setval('public.parties_party_id_seq', 238, true);
...
SELECT pg_catalog.setval('public.payments_payment_id_seq', 1523, true);
...
SELECT pg_catalog.setval('public.payments_ref_seq', 1523, true);
...
SELECT pg_catalog.setval('public.purchaseinvoices_purchase_invoice_id_seq', 217, true);
...
SELECT pg_catalog.setval('public.purchaseitems_purchase_item_id_seq', 4065, true);
...
SELECT pg_catalog.setval('public.purchasereturnitems_return_item_id_seq', 40, true);
...
SELECT pg_catalog.setval('public.purchasereturns_purchase_return_id_seq', 11, true);
...
SELECT pg_catalog.setval('public.purchaseunits_unit_id_seq', 11850, true);
...
SELECT pg_catalog.setval('public.receipts_receipt_id_seq', 1757, true);
...
SELECT pg_catalog.setval('public.receipts_ref_seq', 1757, true);
...
SELECT pg_catalog.setval('public.salesinvoices_sales_invoice_id_seq', 950, true);
...
SELECT pg_catalog.setval('public.salesitems_sales_item_id_seq', 2596, true);
...
SELECT pg_catalog.setval('public.salesreturnitems_return_item_id_seq', 105, true);
...
SELECT pg_catalog.setval('public.salesreturns_sales_return_id_seq', 36, true);
...
SELECT pg_catalog.setval('public.soldunits_sold_unit_id_seq', 13143, true);
...
SELECT pg_catalog.setval('public.stockmovements_movement_id_seq', 25973, true);
...
--
-- Name: contra_entries contra_entries_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.contra_entries
    ADD CONSTRAINT contra_entries_pkey PRIMARY KEY (contra_id);
...
--
-- Name: contra_entries trg_contra_delete; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: contra_entries trg_contra_insert; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: contra_entries trg_contra_update; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: soldunits trg_soldunits_fix_ghost_stock; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: TRIGGER trg_soldunits_fix_ghost_stock ON soldunits; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: contra_entries contra_from_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.contra_entries
    ADD CONSTRAINT contra_from_fk FOREIGN KEY (from_party_id) REFERENCES public.parties(party_id) ON DELETE CASCADE;


--
-- Name: contra_entries contra_journal_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.contra_entries
    ADD CONSTRAINT contra_journal_fk FOREIGN KEY (journal_id) REFERENCES public.journalentries(journal_id) ON DELETE SET NULL;


--
-- Name: contra_entries contra_to_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.contra_entries
    ADD CONSTRAINT contra_to_fk FOREIGN KEY (to_party_id) REFERENCES public.parties(party_id) ON DELETE CASCADE;


--
-- Name: contra_entries contra_user_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.contra_entries
    ADD CONSTRAINT contra_user_fk FOREIGN KEY (created_by) REFERENCES public.auth_user(id) ON DELETE SET NULL;
...
--
-- Name: parties parties_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: purchaseinvoices purchaseinvoices_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: purchasereturns purchasereturns_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: salesinvoices salesinvoices_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: salesreturns salesreturns_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
\unrestrict a0YqUpUTL5neiALUD2W1uXbNOPs7AzI6jNZnaRAE7Ue2XkR49vYVWHglrkgAOnD
